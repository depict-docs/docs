...
For the complete API specification, see [API Reference](/reference).
...
The available types depend on what Depict has configured for you. Common examples include “similar”, “cross\_sell”, and “checkout”. 
