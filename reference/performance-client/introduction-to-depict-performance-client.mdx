...
1. Install the Depict Performance Client SDK. For more information, see [DPC installation](/reference/tracking-product/performance-client#installing).
2. Initialize and integrate DPC into your application. For more information, see [Initializing DPC](/reference/tracking-product/performance-client) and [Tracking product recommendation cards](/tracking-product/performance-client#tracking-product-cards).
