---
title: "Intro to Depict"
description: "Welcome to the Depict documentation!"
---
...
1. Ensure your [data is ingested](/data-ingestion/overview-of-data-ingestion) into our systems.
2. Integrate [our SDK](/home/sdk-intro). You can use our turnkey UI or our API client along with your own UI.

And that's it!

We also highly recommend that you set up our [Depict Performance Client](/tracking-product/introduction-to-depict-performance-client) so that you get insight into how well your marketplace is performing, thanks to Depict. 
