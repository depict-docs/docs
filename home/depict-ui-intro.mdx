...
<CardGroup cols={3}>
    <Card title="Search" href="/reference/search-sdk/search-sdk-overview" icon="magnifying-glass" iconType="duotone"></Card>
    <Card title="Categories" href="/reference/category-sdk/categories-sdk-overview" icon="folders" iconType="duotone"></Card>
    <Card title="Recommendations" href="/reference/recommendations-sdk/recommendations-sdk-overview" icon="bolt-lightning" iconType="duotone"></Card>
</CardGroup>
...
|----------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Vanilla JS** | A vanilla Javascript SDK that can be integrated with other frontend frameworks          | [Search](/reference/search-sdk/search-js-ui-quickstart), [Category](/category-sdk/category-page-javascript-sdk), [Recommendations](/reference/recommendations-sdk/recommendations-sdk-js)  |
| **React**      | A React SDK that can work with client-side frameworks as well as server-side frameworks | [Search](/reference/search-sdk/search-react-sdk), [Category](/reference/category-sdk/category-page-react-sdk), [Recommendations](/reference/recommendations-sdk/recommendations-sdk-react) |
...
Here's the relevant [guide](/api-guide/introduction).