...
This includes all the default styling for all Depict Category Page UI components. You can also customize the SDK styling to fit your website's specifications. For more information, see [Modify and Customize Styling](/reference/category-search/customize-plp-styling-with-scss) in the reference section.