...
<Note>
    The SDK supports page routing in Next.js applications without any extra configuration. If you're using next.js, [skip to the next step](/react-ui-guide/setup/pageURLCreator).
</Note>
